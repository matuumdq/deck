const Services = () => {
	...
	return (
		<div
			id="services"
			className="flex px-5 py-24 flex-col gap-1 w-full text-white bg-harvest-gold-300"
		>
			<div className="max-w-screen-xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 justify-items-center gap-8">
				...
				{services.map((service, index) => (
					...
					>
						<div className="flex flex-col gap-8">
							...
							<button className="w-fit border uppercase px-5 py-2 rounded-md hover:bg-white hover:text-black  ease-out duration-300">
								ver estrategia
							</button>
						</div>
						<img
